...
function conversion(): CpfontConversionResult {
...
describe("cpfont family ZIP package", () => {
  it("is deterministic and contains seven files, checksums, and provenance", async () => {
    ...
    expect(first.name).toBe("ExampleCJK_cpfont-v4.zip");
    ...
    expect(Object.keys(entries)).toEqual([
      ...
      "ExampleCJK/ExampleCJK_16.cpfont",
    ...
    expect(provenance).toMatchObject({
      schemaVersion: 1,
      cpfontVersion: 4,
      physicalSizes: [8, 10, 12, 14, 16, 18, 22],
