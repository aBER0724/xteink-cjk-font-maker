...
export const I18N_COPY = {
  zh: {
    language: "语言",
    title: "CJK 字体转换器",
    description: "生成当前正式 .cpfont v4 七字号字体包；旧版 Bin 与 XBF2 位于旧格式工具。",
    fontLibrary: "字体库",
    makeCpfont: "制作 .cpfont",
    legacyTools: "旧格式工具",
    outputFormatCpfont: ".cpfont v4（正式）",
    cpfontSizes: "物理字号：8 / 10 / 12 / 14 / 16 / 18 / 22 pt",
    ...
    catalogLoading: "正在加载字体库…",
    catalogError: "字体库暂时不可用。转换功能仍可继续使用。",
    catalogOpen: "打开独立字体目录",
    catalogSearch: "搜索字体",
    catalogPreviewSize: "预览字号",
    catalogAll: "全部",
  ...
  ja: {
    ...
    description: "現在の正式な .cpfont v4 を 7 サイズで生成します。旧 Bin と XBF2 は旧形式ツールにあります。",
    fontLibrary: "フォントライブラリ",
    makeCpfont: ".cpfont を作成",
    legacyTools: "旧形式ツール",
    outputFormatCpfont: ".cpfont v4（正式）",
    cpfontSizes: "物理サイズ: 8 / 10 / 12 / 14 / 16 / 18 / 22 pt",
    ...
    catalogLoading: "フォントライブラリを読み込み中…",
    catalogError: "ライブラリを読み込めません。変換機能は引き続き利用できます。",
    catalogOpen: "独立カタログを開く",
    catalogSearch: "フォント検索",
    catalogPreviewSize: "プレビューサイズ",
    catalogAll: "すべて",
  ...
  en: {
    ...
    description: "Generate the current seven-size .cpfont v4 package. Legacy Bin and XBF2 are available under Legacy Tools.",
    fontLibrary: "Font Library",
    makeCpfont: "Make .cpfont",
    legacyTools: "Legacy Tools",
    outputFormatCpfont: ".cpfont v4 (current)",
    cpfontSizes: "Physical sizes: 8 / 10 / 12 / 14 / 16 / 18 / 22 pt",
    ...
    catalogLoading: "Loading font library…",
    catalogError: "The font library is unavailable. Private conversion still works.",
    catalogOpen: "Open standalone catalog",
    catalogSearch: "Search fonts",
    catalogPreviewSize: "Preview size",
    catalogAll: "All",
